...
namespace HousingOutlook2.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public AuthenticationController(ILogger<AuthenticationController> logger, IUserService userServices)
        {
            _logger = logger;
        ...
        {
            UserLogin userDetails = new UserLogin(HttpContext.Session.GetString("userEmail"), HttpContext.Session.GetString("userPass"));
